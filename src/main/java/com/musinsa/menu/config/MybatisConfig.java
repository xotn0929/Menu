...
@MapperScan(        //Mybatis Mapper를 설정하기 위한 어노테이션
    basePackages = {"com.musinsa.**.mapper"},   //Mapper를 찾을 Package를 명시하는 속성
...
public class MybatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource) throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:/mybatis/mapper/*Map.xml"));    //Mapper xml파일의 위치를 명시
